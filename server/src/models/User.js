...
userSchema.index({ role: 1 }, { unique: true, partialFilterExpression: { role: 'ROOT' } });

userSchema.set('toJSON', { transform(_document, value) { delete value.passwordHash; delete value.__v; return value; } });
