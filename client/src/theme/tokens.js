...
export const typographyTokens = Object.freeze({
  ...
  sizes: {
    ...
    body: '0.875rem',
    bodyLarge: '0.9375rem',
    panelHeading: '0.9375rem',
    sectionHeading: '1.125rem',
    pageHeading: '1.5rem',
    metric: '1.25rem',
    metricLarge: '1.625rem',
  },
});
...
export const zIndexTokens = Object.freeze({
  base: 0,
  sticky: 10,
  navigation: 20,
  appBar: 30,
...
const darkColors = {
  ...
  financial: {
    positive: '#72AE83',
    positiveStrong: '#8BC59A',
    positiveBg: '#17291D',
    positiveBorder: '#315C3D',
    negative: '#D47773',
    negativeStrong: '#E38C87',
    negativeBg: '#2B1B1A',
    negativeBorder: '#6C3D39',
  },
  status: {
    warning: '#C49A54',
    warningBg: '#2A2418',
    warningBorder: '#66522D',
    info: '#7FA1B2',
    infoBg: '#18252A',
    infoBorder: '#385764',
    neutral: '#AAAFA8',
    neutralBg: '#202420',
    neutralBorder: '#414841',
  },
  focus: '#85B796',
  overlay: 'rgba(6, 8, 6, 0.72)',
  chart: {
    primary: '#6B9B7B',
    secondary: '#9B7738',
    comparison: '#7FA1B2',
...
const lightColors = {
  ...
  financial: {
    positive: '#25613E',
    positiveStrong: '#194C2E',
    positiveBg: '#E3F0E6',
    positiveBorder: '#A9CDB2',
    negative: '#9D3F3F',
    negativeStrong: '#7F2F2F',
    negativeBg: '#F5E6E3',
    negativeBorder: '#DBB1AB',
  },
  status: {
    warning: '#805C1F',
    warningBg: '#F5ECD7',
    warningBorder: '#DCC494',
    info: '#315F78',
    infoBg: '#E4EFF3',
    infoBorder: '#B0CDD7',
    neutral: '#60645E',
    neutralBg: '#EFEEE9',
    neutralBorder: '#D1CEC5',
  },
  focus: '#276844',
  overlay: 'rgba(20, 22, 19, 0.42)',
  chart: {
    primary: '#326D4C',
    secondary: '#87662E',
    comparison: '#315F78',
...
const shadows = {
  ...
  light: {
    none: 'none',
    sm: '0 2px 8px rgba(34, 31, 24, 0.08)',
    md: '0 10px 28px rgba(34, 31, 24, 0.12)',
    lg: '0 20px 52px rgba(34, 31, 24, 0.16)',
  },
};
