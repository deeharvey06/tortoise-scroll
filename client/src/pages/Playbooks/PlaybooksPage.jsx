  ...
  return (
    <Box>
      <PageHeader
        ...
        title='Playbooks'
        description='Your collection of repeatable patterns—defined clearly, checked before execution, and validated by recorded trades.'
        actions={
          <Button
            variant='contained'
            size='small'
      ...
      {initialLoading ? (
        ...
        <EmptyState
          ...
          description='Define your first setup and turn it into a repeatable execution process.'
          action={
                  ...
                  >
                    <ListItemText
                      ...
                      primaryTypographyProps={{
                        fontWeight: p._id === selectedId ? 700 : 500,
                      }}
                    />
                  </ListItemButton>
                ))}
          ...
          <Grid item xs={12} md={9}>
            {selected && (
              <>
                ...
                >
                  <Box>
                    <Typography variant='h5'>{selected.setupName}</Typography>
                    <StatusBadge
                      label={
                        selected.isActive === false ? 'Inactive' : 'Active'
                      }
                      tone={
                        selected.isActive === false ? 'neutral' : 'positive'
                      }
                      sx={{ mt: 1 }}
                    />
                  </Box>
                ...
                <SectionHeader
                  ...
                  description='Results calculated from trades assigned to this playbook.'
                />
                {perfLoading ? (
                ...
                <Grid container spacing={3} sx={{ mb: 3 }}>
                  <Grid item xs={12} lg={8}>
                    <Panel sx={{ mb: 3 }}>
                      ...
                      >
                        {selected.description || 'No description documented.'}
                      </Typography>
                    ...
                    {(selected.examples || selected.counterexamples) && (
                      <Panel sx={{ mb: 3 }}>
                        <SectionHeader
                          eyebrow='Evidence'
                    ...
                    <Panel>
                      ...
                      {(selected.screenshots || []).length === 0 ? (
                        <EmptyState
                          compact
                          title='No evidence screenshots'
                          description='Upload strong examples or counterexamples for this pattern.'
                        />
                      ) : (
                  ...
                  <Grid item xs={12} lg={4}>
                    <Panel sx={{ position: { lg: 'sticky' }, top: { lg: 88 } }}>
                      <Typography variant='overline' color='text.secondary'>
                        Pre-trade checklist ({checkedCount}/
                      ...
                      >
                        Run through this before taking the trade — it resets
                        each time you switch playbooks.
                      </Typography>
                      {(selected.checklist || []).length ? (
                        ...
                        <EmptyState
                          ...
                          description='This playbook has no checklist items.'
                        />
                      )}
                    </Panel>
                  </Grid>
                ...
                <Panel padding={0}>
                  <Box sx={{ p: 3 }}>
                    <SectionHeader
                      ...
                      description={`The ${Math.min(associatedTrades.length, 8)} most recent trades assigned to this playbook.`}
                      sx={{ mb: 0 }}
                    />
                  </Box>
                  {associatedTrades.length ? (
                    ...
                    <EmptyState
                      ...
                      description='Assign trades to this playbook from the Trade form to validate the pattern.'
                    />
                  )}
                </Panel>
              </>
